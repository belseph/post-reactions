export interface TagInfo {
  id: string;
  label: string;
  shortLabel?: string; // Para mostrar en espacios reducidos
  description?: string;
}

// ✅ FUENTE ÚNICA DE VERDAD: Todas las etiquetas disponibles
...
// ✅ TAGS PARA FILTROS EN HEADER (incluye "Todos")
